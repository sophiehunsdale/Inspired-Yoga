<?php
  ...
  if(!isset($_SESSION['admindash'])){
    ...
    $read = "SELECT inspired_yoga_announcements.content, inspired_yoga_announcements.title, inspired_yoga_announcements.publish_date, inspired_yoga_coaches.coach_name  
         FROM inspired_yoga_announcements
         INNER JOIN inspired_yoga_coaches
         ON inspired_yoga_announcements.auth_id = inspired_yoga_coaches.coach_id 
...
<body>
    <div id="container">
        ...
        <div id="text">
            <section>
                <p>
                    <h3 id="h3" class="pad pull-right">Announcements</h3>
                </p>
                <div style="text-align: center">
                    <p>
                    <a href="announcementupload.php" class="btn btn-outline-dark">New Announcement </a> <a href="announcementsmy.php" class="btn btn-outline-dark">My Announcements </a>
                    </p>
                </div>
