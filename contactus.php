    ...
    <div id="container">
        ...
        <div id="text">
            <form class="form-contact" method="post">
                <fieldset>							
                   <h4 id='h3'> Contact Us </h4>
                   <p>
                    <form>
                       <div class="form-group">
                            <label for="inputName" class="sr-only">Name</label>
            	            <input type="name" name="name" id="inputName" class="form-control nput-lg" placeholder="Your Name" required>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail" class="sr-only">E-Mail</label>
        	                <input type="email" name="email" id="inputEmail" class="form-control input-lg" placeholder="name@email.com" required>
                        </div>
                        <div class="form-group">
                            <label for="inputSubject" class="sr-only">Subject</label>
        	                <input type="name" name="subject" id="inputSubject" class="form-control input-lg" placeholder="Your Subject Line" required>                 
                        </div>
                        <div class="form-group">
                            <label for="inputMessage" class="sr-only">Message</label>
                            <textarea class="form-control input-lg" id="inputMessage" name="message" rows="3"></textarea>
                        </div>
                        <p>
                            <div>
                    ...
                    <?php
                        ...
                        if((isset($_POST['name']) && !empty($_POST['name']))
                            ...
                            $insertinfo = "INSERT INTO inspired_yoga_contact_form_info (name, email, subject, message)
                            VALUES ('$name', '$email', '$subject','$message')";

                            $result = $conn->query($insertinfo);
	
                        	$to = "shunsdale01@qub.ac.uk";
	                        $headers = "From : " . $email;
