        ...
        <div id="text">
            <section>
                <div class="container-fluid">
			        ...
			        <div class="row">
				        <div class="col-md-5">
 					        <form role="form" method="post" action="groupadd.php?op=in">
    						    <fieldset>							
	    						    <p class="text-uppercase pull-center"> New Group </p>	
                                   <div class="form-group">
	    		    					<input type="text" name="groupname" class="form-control input-lg" placeholder="Group Name">
		    		    			</div>
                                    <div class="form-group">
				    		    		<input type="text" name="groupdescription" class="form-control input-lg" placeholder="Group Description">
					    		    </div>
                                    <div class="form-group">
	    		    					<input type="text" name="program" class="form-control input-lg" placeholder="Program Description">
		    		    			</div>
                                    <div class="form-group">
				    		    		<input type="text" name="schedule" class="form-control input-lg" placeholder="Schedule">
					    		    </div>
                                    <div class="form-group">
                                    ...
                                    <p>
                                        <div>
 	    			    	    			<input type="submit" class="btn btn-outline-dark" value="Create" name='create'>
                                         </div>
                                    </p>
                                    <?php
                                        ...
                                        if(isset($_POST['create'])){
                                            ...
                                            $insertgroup = "INSERT INTO inspired_yoga_groups (groupname, groupdescription, program, schedule, price) VALUES ('$groupname', '$groupdescription', '$program', '$schedule', $price)";
                                            
                                            
                                            $result = $conn->query($insertgroup);
                                  
                                            if ($conn->query($insertgroup) === TRUE) {
                                                echo "$groupname created successfully";
                                            } else {
