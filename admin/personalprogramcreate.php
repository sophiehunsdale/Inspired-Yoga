...
<head>
    ...
    <title>Create Personal Program</title>
...
<body>
    <div id="container">
        ...
        <div id="text">
            <p>
                <h3 id="h3" class="pad pull-right">Create Personal Program</h3>
            </p>
                <div style="text-align: center">
                    <p>
                    <a href="personalprogrammanage.php" class="btn btn-outline-dark">View All</a> 
                    </p>
                </div>
            <section>
                <form action='personalprogramcreate.php' method='POST' enctype="multipart/form-data">
		            <div class="ui grid ">
			            <div class="row" id="text">		
				            <div class="ui form">
        				        <div class="field">
                                    <label>Insert Program: </label>
                                    <p>
                                        <input type="text" name="programtitle" class="form-control input-lg" placeholder="Program Title">
                                    </p>
                                    <p>
                                        <input type="text" name="programprice" class="form-control input-lg" placeholder="Price: £">
                                    </p>
                                    <p>
                                        <input type="text" name="programdetails" class="form-control input-lg" placeholder="Details">
                                    </p>
    				            </div>
	    			        </div>
		    	        </div>
            ...
            <?php
    		    ...
    		    if(isset($_POST['upload'])){
                    ...
                    $programdetails = $_POST['programdetails'];

        			$user = $_SESSION['admindash'];

	        		$insertprogram = "INSERT INTO inspired_yoga_training_programs (program_title, program_price, program_details)
		        					VALUES ('$programtitle', '$programprice', '$programdetails');";

			        $result = $conn->query($insertprogram);

			        if(!$result){
				        echo $conn->error;
        			}else{
	        			echo "<p> Program: $programtitle uploaded. </p>";
                    } 
		        }	
            ?>
        </div>
