...
<body>
    <div id="container">
        ...
        <?php
                $read = "SELECT * FROM inspired_yoga_classes;";
                    ...
                    echo "<p> 
                        ...
                        <div class='row'>
                            <div class='col-lg-3 col-md-12 col-sm-12' id='imgcol'>
                                <img id='instructor' style='padding-left:10%;' src='upload/$path' />
                            </div>
                            <div class='col-lg-9 col-md-12 col-sm-12' id='textcol'>
                                <h4 id='h3'><b>$class_name</b></h4>
                                <h5 id='h3'><b> Coach: </b>$coach_name </h5>
                                <p> <b>Price:</b> £ $price</p>
                                <p> <b>Length:</b> $class_length mins</p>
                                <p> $class_description </p>
                                <p>
                                <p> 
                                  <a href='scheduleadddate.php?adddate=$class_id' class='btn btn-outline-dark'>Add Date</a>
                                </p>
