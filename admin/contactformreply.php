        ...
        <div id="text">
                <fieldset>							
                   ...
                   <?php
                        ...
                        $myid = $_GET['submission'];

                        $read = "SELECT * FROM inspired_yoga_contact_form_info WHERE id=$myid;";
                              ...
                              echo "
                               <form class='form-contact' method='post'>
                                    <div class='form-group'>
                        	            ...
                        	            <input type='name' value='$contactname' name='name' id='inputName' class='form-control nput-lg' required>
                                    </div>
                                    <div class='form-group'>
                                        <label for='inputEmail' class='sr-only'>E-Mail</label>
        	                            <input type='email' value='$contactemail' name='email' id='inputEmail' class='form-control input-lg' required>
                                    </div>
                                    <div class='form-group'>
                                        <label for='inputSubject' class='sr-only'>Subject</label>
                	                    <input type='name' value='$contactsubject' name='subject' id='inputSubject' class='form-control input-lg' required>                 
                                    </div>
                                    <div class='form-group'>
