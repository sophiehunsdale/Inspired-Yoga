...
<body>
    <div id="container">
        ...
        <div id="text">
            ...
            <?php
                    $program_id = $_GET['editID'];

                    $readcoach = "SELECT * FROM inspired_yoga_training_programs WHERE program_id='$program_id';";
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<form method='POST' action='personalprogramupdate.php'>
                                <input type='hidden' value='$id' name='programid'>
                                <p> 
                                   Title: 
                                </p>
                                <p>
                                    <input value='$programtitle' name='programtitle' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Price: 
                                </p>
                                <p>
                                    <input value='$programprice' name='programprice' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Details: 
                                </p>
                                <p>
                                    <input value='$programdetails' name='programdetails' class='form-control input-lg'> 
                                </p>
                                <div style='text-align: right; padding-top:2%;'>
                                    <p> 
                                    <a href='personalprogrammanage.php' class='btn btn-outline-dark'>back</a>  <input type='submit' class='btn btn-outline-dark' value='update'> 
                                    </p>
                                </div>
                        </form> ";
