<?php
  ...
  if(isset($_POST['admin'])){
        ...
        $auth = "SELECT * FROM inspired_yoga_coaches WHERE username='$admin_name' AND coach_password='$passw'";
        ...
        if($numrows > 0){
            while ($row=$result->fetch_assoc()){
                $adminuser = $row['coach_id']; 
              }

            $_SESSION['admindash']=$adminuser;
			...
			<div class="row">
		        <div class="col-md-5">
 			        <form role="form" method="POST" action="login.php">
			            <fieldset>							
			                <p class="text-uppercase"> Admin Login: </p>	
 				   				<div class="form-group">
		    	                	<input type="text" name="admin" class="form-control input-lg" placeholder="Username">
                				</div>
                                <div class="form-group">
