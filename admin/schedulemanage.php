...
<body>
    <div id="container">
        ...
        <div id="text">
            <p>
                <h3 id="h3" class="pad pull-right">Schedule</h3>
            </p>
            <?php
                $read = "SELECT * FROM inspired_yoga_class_calendar
                INNER JOIN inspired_yoga_classes 
                ON inspired_yoga_class_calendar.class_id = inspired_yoga_classes.class_id ORDER BY class_date ASC";
                ...
                if(!$result){
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        echo "<p> <div class='card-deck'>
                            <div class='card'>
                                <div class='row' >
                                        <h4 id='h3' style='padding-left:4%;'> $newday</h4>
                                </div>
                                <div class='row'>
                                    <div class='col-sm-5'>
                                        <p class='card-text'>
                                        <p>
                                            <b id='h3' style='padding-left:4%;'> Class:</b> $get_title
                                        </p>
                                        <p>
                                            <b id='h3'style='padding-left:4%;' > Time: </b> $get_time
                                        </p>
                                    </div>
                                </div>
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='scheduleedit.php?editID=$get_title' class='btn btn-outline-dark'>Edit</a>
                                    </p>
                                </div>
                            </div>  
                        </div>
