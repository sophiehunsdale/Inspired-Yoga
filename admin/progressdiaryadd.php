...
<body>
    <div id="container">
        ...
        <div id="text">
            <section>
            <p>
                    <h3 id="h3" class="pad pull-right">Upload Progress Report</h3>
                </p>
                <div id=text>
                <div style="text-align: center">
                    <p>
                    <a href="progressdiary.php" class="btn btn-outline-dark">View Progress Diary </a>
                    </p>
                </div>
                <form action='progressdiaryadd.php' method='POST' enctype="multipart/form-data">
		              <div class="ui grid ">
			              <div class="row" id="text">		
	  			            <div class="ui form">
          				        <div class="field">
                              <label>Insert New Progress Report: </label>
                             <p>
            ...
            <?php
                if(isset($_POST['upload'])){
                    ...
                    $user = $_SESSION['admindash'];
    			          ...
    			          $uploadprogress = "INSERT INTO inspired_yoga_progress_diary (title, content, publish_date, auth_id)
	        				    VALUES ('$title', '$content', '$publishdate','$user')";

                    $result = $conn->query($uploadprogress);

	    		    if(!$result){
		    		    echo $conn->error;
                    }else{
    				    echo "<p> Progress report: $title uploaded. </p>";
	    		    }
		        }
            ?>
        </div>
