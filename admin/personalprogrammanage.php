...
<body>
    <div id="container">
        ...
        <div style="text-align: center">
                    <p>
                    <a href="personalprogramcreate.php" class="btn btn-outline-dark">Create Program</a> 
                    </p>
                </div>
                <p>
                    <h3 id="h3" class="pad pull-right">Personal Training Programs</h3>
                </p>
                
                <?php
                    $read = "SELECT * FROM inspired_yoga_training_programs";
                        ...
                        echo "<p> <div class='card-deck' >
                            <div class='card'>
                                <div class='row'style='padding-left:2%; padding-top:2%;'>
                                    <div class='col-sm-5'>
                                            <h4 id='h3'> $programtitle</h4>
                                            <p class='card-text'>
                                                <p>
                                                    <b id='h3'> Price:</b> $programprice
                                                </p>
                                                <p>
                                                    <b id='h3'> Details:</b> $programdetails 
                                                </p>
                                            </p>
                                ...
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='personalprogramedit.php?editID=$programid' class='btn btn-outline-dark'>Edit</a>
                                    </p>
                                </div>
                            </div>  
                        </div>
