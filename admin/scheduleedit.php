    ...
    <div id="container">
        ...
        <div id="text">
            ...
            <?php
                    ...
                    $readcalendar = "SELECT * FROM `inspired_yoga_class_calendar` 
                    INNER JOIN inspired_yoga_classes 
                    ON inspired_yoga_class_calendar.class_id = inspired_yoga_classes.class_id WHERE calendar_class_id='$class_id';";
                    $result = $conn->query($readcalendar);
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        $get_theday=$row['class_date'];
                        $get_id = $row['calendar_class_id'];
                        $get_time=$row['class_time'];

                        $newday=date('l, jS M Y', strtotime($get_theday));
                        ...
                        echo "<form method='POST' action='scheduleupdate.php'>
                                ...
                                <p> 
                                    <b id='h3'>Current Date: </b> $newday 
                                </p>
                                 <p> 
                                    <b id='h3'>Current Time: </b> $get_time 
                                </p>
                                <p> 
                                    <b id='h3'>Date: </b>
                                </p>
                                <p>
                                    <input type='date' value='$get_theday' name='changedate' class='form-control input-lg'> 
                                </p>
                                <p> 
                                   <b id='h3'> Time: </b>
                                </p>
                                <p>
                                    <input type='time' value='$get_time' name='changetime' class='form-control input-lg'> 
                                </p>
                               
                                <div style='text-align: right; padding-top:2%;'>
                                    <p> 
                                    <a href='schedulemanage.php' class='btn btn-outline-dark'>back</a>  
