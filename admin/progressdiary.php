<?php
  ...
  if(!isset($_SESSION['admindash'])){
    ...
    $read = "SELECT inspired_yoga_progress_diary.title, inspired_yoga_progress_diary.content, inspired_yoga_progress_diary.publish_date, inspired_yoga_coaches.coach_name  
         FROM inspired_yoga_progress_diary 
         INNER JOIN inspired_yoga_coaches
         ON inspired_yoga_progress_diary.auth_id = inspired_yoga_coaches.coach_id 
...
<body>
  <div id="container">
        ...
        <div id="text">
            <section>
                <p>
                    <h3 id="h3" class="pad pull-right">Progress Diary</h3>
                </p>
                <div id=text>
                <?php
