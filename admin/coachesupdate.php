        ...
        <div id="text">
            <div class="row">
                ...
                <?php 
                    ...
                    $coachname = $conn->real_escape_string($_POST['changename']);
                    $coachemail = $conn->real_escape_string($_POST['changemail']);
                    $coachusername = $conn->real_escape_string($_POST['changeusername']);
                    $coachpassword = $conn->real_escape_string($_POST['changepassword']);
                    $coachbio= $conn->real_escape_string($_POST['changebio']);

                    $update = "UPDATE inspired_yoga_coaches 
                    SET coach_name='$coachname', coach_email='$coachemail', username='$coachusername', coach_password='$coachpassword', bio='$coachbio' 
                    WHERE coach_id='$id'";
                    ...
                    echo    "<div>
                            ...
                            <div style='text-align:right'>
                                <a href='coachesmanage.php' class='btn btn-outline-dark'>Manage Coaches</a>
                            </div>
                        ";
                    }
                ?>	
