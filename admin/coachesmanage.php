...
<body>
    <div id="container">
        ...
        <div id="text">
                <p>
                    <h3 id="h3" class="pad pull-right">Coaches</h3>
                </p>
                            ...
                            <div class='card'>
                                <div class='row'>
                                    ...
                                    <div class='col-sm-5'>
                                            ...
                                            <p class='card-text'>
                                                <p>
                                                    <b id='h3'> Email:</b> $get_coachemail
                                                </p>
                                                <p>
                                                    <b id='h3'> Username:</b> $get_coachusername 
                                                </p>
                                            </p>
                                ...
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='coachesedit.php?editID=$coachid' class='btn btn-outline-dark'>Edit</a>
                                    </p>
                                </div>
                            </div>  
                        </div>
