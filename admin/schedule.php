...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="../styles/calendartheme.css"/>
  ...
  <div id="container">
        ...
        <div id="text">
            <p>
                ...
                <p>
                    <a href="schedulemanage.php" class="btn btn-outline-dark">Edit Schedule</a>
                </p>
            ...
            <script>
               ...
               <?php
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        echo "{'Date': new Date($newday), 'Title': '$title', 'Link': 'scheduledetails.php?rowid=$id'},";
                    }
                    echo " ]; ";
