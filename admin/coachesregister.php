...
<body>
    <div id="container">
        ...
        <div id="text">
            <p>
                <h3 id="h3" class="pad pull-right">Manage Coaches</h3>
            </p>
                <div style="text-align: center">
                    <p>
                    <a href="coachesedit.php" class="btn btn-outline-dark">Edit Coaches </a> 
                    </p>
                </div>
            <section>
                <form action='coachesregister.php' method='POST' enctype="multipart/form-data">
		            <div class="ui grid ">
			            <div class="row" id="text">		
				            <div class="ui form">
        				        <div class="field">
                                    <label>Insert New Coach: </label>
                                    <p>
                                        <input type="text" name="coachname" class="form-control input-lg" placeholder="Coach Name">
                                    </p>
                                    <p>
                                        <input type="text" name="coachemail" class="form-control input-lg" placeholder="Email">
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        <input type="text" name="bio" class="form-control input-lg" placeholder="Bio">
                                    </p>
    				            </div>
	    			        </div>
		    	        </div>
            ...
            <?php
    		    ...
    		    if(isset($_POST['upload'])){
                    ...
                    $coachusername = $_POST['username'];
                    $coachpassword = $_POST['password'];
                    $coachbio = $_POST['bio'];
	        		...
	        		$insertcoach = "INSERT INTO inspired_yoga_coaches (coach_name, coach_email, username, coach_password, bio, path) VALUES ('$coachname', '$coachemail', '$coachusername', '$coachpassword', '$coachbio', '$filename');";

			        $result = $conn->query($insertcoach);

			        if(!$result){
				        echo $conn->error;
        			}else{
	        			echo "<p> Coach: $coachname uploaded. </p>";
                    } 
		        }	
            ?>
        </div>
