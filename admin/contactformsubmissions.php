...
<body>
    <div id="container">
        ...
        <div id="text">
                <p>
                    <h3 id="h3" class="pad pull-right">Inbox</h3>
                </p>
                
                <?php
                    $read = "SELECT * FROM inspired_yoga_contact_form_info ORDER BY id";
                        ...
                        echo "<p> <div class='card-deck'>
                            <div class='card'>
                                <div class='row' style='margin:auto; padding:auto;'>
                                    <div class='col-sm-5'>
                                            <h3 id='h3'> $contactname</h3>
                                            <p class='card-text'>
                                                <p>
                                                    <b id='h3'>Email:</b> $contactemail
                                                </p>
                                                <p>
                                                <b id='h3'>Subject: </b> $contactsubject 
                                                </p>
                                            </p>
                                        </div>
                                    </div>
                                <div class='row' style='margin:auto; padding:auto;'>
                                    <p style='padding-top:2%;'>
                                        <b id='h3'> Message: </b> $contactmessage
                                    </p>
                                </div>
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='contactformreply.php?submission=$submissionid' class='btn btn-outline-dark'>Reply</a>
                                    </p>
                                </div>
                            </div>  
                        </div>
