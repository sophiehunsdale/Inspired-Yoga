    ...
    <div id="container">
        ...
        <div id="text">
                ...
                <?php 
                    ...
                    $get_title= $conn->real_escape_string($_POST['programtitle']);
                    $get_id = $conn->real_escape_string($_POST['programid']);
                    $get_price=$conn->real_escape_string($_POST['programprice']);
                    $get_details=$conn->real_escape_string($_POST['programdetails']);
                    
                    $update = "UPDATE inspired_yoga_training_programs 
                    SET program_title='$get_title', program_price='$get_price', program_details='$get_details'
                    WHERE program_id='$get_id';";
                    ...
                    echo    "<div>
                            ...
                            <div style='text-align:right'>
                                    <a href='personalprogrammanage.php' class='btn btn-outline-dark'>Manage Programs</a>
                            </div>
                            ";
                    }
                ?>	
