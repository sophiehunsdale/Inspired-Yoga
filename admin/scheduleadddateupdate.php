    ...
    <div id="container">
        ...
        <div id="text">
                ...
                <?php 
                    ...
                    $get_theday= $conn->real_escape_string($_POST['adddate']);
                    $get_id = $conn->real_escape_string($_POST['changeid']);
                    $get_time=$conn->real_escape_string($_POST['addtime']);
                    
                    
                    $update = "INSERT INTO inspired_yoga_class_calendar (class_id, class_time, class_date) 
                    VALUES ('$get_id', '$get_time', '$get_theday')";
