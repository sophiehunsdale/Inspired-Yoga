<?php
  ...
  if(!isset($_SESSION['admindash'])){
    ...
    $myannouncments = "SELECT * FROM inspired_yoga_announcements WHERE auth_id = '$coach'";

    $result = $conn->query($myannouncments);
?>
...
<body>
    <div id="container">
        ...
        <div id="text">
                <p>
                    <h3 id="h3" class="pad pull-right">My Announcements</h3>
                </p>
                <div style="text-align: center">
                    <p>
                    <a href="announcementupload.php" class="btn btn-outline-dark">New Announcement </a> <a href="announcements.php" class="btn btn-outline-dark">All Announcements </a>
                    </p>
                </div>
                <?php
                    if($result){
