...
<body>
    <div id="container">
        ...
        <div id="text">
                <p>
                    <a href="clientmanage.php" class="btn btn-outline-dark">View All</a>
                </p>
            <section>
                <form action='clientregister.php' method='POST' enctype="multipart/form-data">
		            <div class="ui grid ">
			            <div class="row" id="text">		
				            <div class="ui form">
        				        <div class="field">
                                    <label>Insert New Client: </label>
                                   <p>
	    		    					<input type="text" name="name" class="form-control input-lg" placeholder="Full Name">
		    		    			</p>
                                    <p>
	    					    		<input type="text" name="contactno" class="form-control input-lg" placeholder="Contact Number">
		    					   </p>
                                   <p>
                                    ...
                                    <p>
		    				    		...
		    				    		<input type="text" name="postcode" class="form-control input-lg" placeholder="Postcode">
    			    				</p>
                                    <p>
				        ...
				        <div class="row" id="text">	
				            <div class="ui form">
                                ...
                                <div style='text-align: right'>
                                    <input style="text-align: right"class="btn btn-outline-dark" type="submit" value="Register" name="upload">	
                                </div>
                            </div>
                        </div>
                    </div>  
            ...
            <?php
                ...
                if(isset($_POST['upload'])){
                    ...
                    $insertuser ="INSERT INTO inspired_yoga_users (user_name, pass, username, email, contactno, address_line, city, postcode, path)
                        VALUES ('$name', '$passw', '$user_name', '$mail', '$phone', '$home', '$city', '$post', '$filename');";
                    ...
                    if(!$result){
                        ...
                        echo "User $user_name added, an email has been sent to $mail";
                            
                        $msg = "Thank you for signing up to Inspire Yoga!
                                We're so pleased to start this journey with you. 
                                Why dont you head over to our website and check out your new dashboard by logging in using your new log in credentials:
                                username: $user_name 
                                password: $passw.";

                        mail($mail, "Welcome to Inspire Yoga!", $msg);
                    }
