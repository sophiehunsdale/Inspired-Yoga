...
<body>
    <div id="container">
        ...
        <div id="text">
                <p>
                    <h3 id="h3" class="pad pull-right">Clients</h3>
                </p>
                <p>
                    <a href="clientregister.php" class="btn btn-outline-dark">Register</a>
                </p>
                ...
                <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $get_useremail = $row['email'];
                        $get_usercontactno = $row['contactno'];
                        $get_useraddress = $row['address_line'];
                        $get_usercity = $row['city'];
                        $get_userpostcode = $row['postcode'];
                        $get_path = $row['path'];
                        
                        
                        echo "<p> <div class='card-deck'>
                            <div class='card'>
                                <div class='row'>
                                    <div class='col-sm-3'>
                                        <img class='card-img-top' style='width:70%;' id='imagecenter' src='upload/$get_path' alt='Card image cap'>
                                    </div>
                                    <div class='col-sm-5'>
                                            <h4 id='h3'> $get_user_name</h4>
                                            <p class='card-text'>
                                               <p><p><b> Email:</b> $get_useremail</p>
                                               <p><b> Username:</b> $get_username </p>
                                               <p><b> Contact Number:</b> $get_usercontactno </p>
                                               <p><b> Address:</b> $get_useraddress, $get_usercity, $get_userpostcode </p>
                                            </p>
                                    </div>
                                    </div>
                            </div>  
