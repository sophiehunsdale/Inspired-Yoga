...
<body>
    <div id="container">
        ...
        <div id="text">
            <section>
            <p>
                    <h3 id="h3" class="pad pull-right">Upload Announcement</h3>
                </p>
                <div id=text>
                <div style="text-align: center">
                    <p>
                    <a href="announcements.php" class="btn btn-outline-dark">All Announcement </a> <a href="announcementsmy.php" class="btn btn-outline-dark">My Announcements </a>
                    </p>
                </div>
                <form action='announcementupload.php' method='POST' enctype="multipart/form-data">
		              <div class="ui grid ">
			              <div class="row" id="text">		
	  			            <div class="ui form">
          				        <div class="field">
                              <label>Insert New Announcement: </label>
                             <p>
                                <input type="text" name="title" class="form-control input-lg" placeholder="Title">
                              </p>
                              <p>
                                <input type="text" name="content" class="form-control input-lg" placeholder="Content">
                              </p>
                              <p>
                                <input type="date" name="publishdate" class="form-control input-lg" placeholder="Date">
                              </p>
      				             </div>
	      			        </div>
                    </div>
            ...
            <?php
                if(isset($_POST['upload'])){
                    ...
                    $user = $_SESSION['admindash'];
    			          ...
    			          $uploadannouncement = "INSERT INTO inspired_yoga_announcements (title, content, publish_date, auth_id)
	        				    VALUES ('$title', '$content', '$publishdate','$user')";

                    $result = $conn->query($uploadannouncement);

	    		    if(!$result){
		    		    echo $conn->error;
                    }else{
    				    echo "<p> Announement: $title uploaded. </p>";
	    		    }
		        }
            ?>
        </div>
