    ...
    <div id="container">
        ...
        <div id="text">
                ...
                <?php 
                    ...
                    $get_theday= $conn->real_escape_string($_POST['changedate']);
                    $get_id = $conn->real_escape_string($_POST['changeid']);
                    $get_time=$conn->real_escape_string($_POST['changetime']);
                    
                    
                    $update = "UPDATE inspired_yoga_class_calendar
                    SET class_date='$get_theday', class_time='$get_time'
                    WHERE calendar_class_id='$get_id'";
                    ...
                    echo    "<div>
                            ...
                            <div style='text-align:right'>
                                    <a href='schedulemanage.php' class='btn btn-outline-dark'>Manage Schedule</a>
                            </div>
                            ";
                    }
                ?>	
