...
<body>
    <div id="container">
        ...
        <div id="text">
            ...
            <?php
                    $coach_id = $_GET['editID'];

                    $readcoach = "SELECT * FROM inspired_yoga_coaches WHERE coach_id='$coach_id';";
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        $coachpassword = $row['coach_password'];
                        $coachbio= $row['bio'];

                        echo "<form method='POST' action='coachesupdate.php'>
                                <input type='hidden' value='$id' name='changeid'>
                                <p> 
                                   Name: 
                                </p>
                                <p>
                                    <input value='$coachname' name='changename' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Email: 
                                </p>
                                <p>
                                    <input value='$coachemail' name='changemail' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Username: 
                                </p>
                                <p>
                                    <input value='$coachusername' name='changeusername' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Password:
                                </p>
                                <p>
                                    <input value='$coachpassword' type='password' name='changepassword' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Bio:
                                </p> 
                                <p>
                                    <textarea name='changebio' class='form-control input-lg'>$coachbio</textarea>
                                </p>
                                <div style='text-align: right; padding-top:2%;'>
                                    <p> 
                                    <a href='coachesmanage.php' class='btn btn-outline-dark'>back</a>  <input type='submit' class='btn btn-outline-dark' value='update'> 
                                    </p>
                                </div>
                        </form> ";
