...
<body>
    <div id="container">
        ...
        <div id="text">
            <section>
                <h4 id="h3" class="title">New Class</h1>
                <form action='scheduleaddclass.php' method='POST' enctype="multipart/form-data">
		            <div class="ui grid ">
			            <div class="row" id="text">		
				            <div class="ui form">
        				        <div class="field">
                                    <label>Insert New Class: </label>
                                    <p>
                                        <input type="text" name="classname" class="form-control input-lg" placeholder="Class Name">
                                    </p>
                                    <p>
                                        <input type="text" name="coachname" class="form-control input-lg" placeholder="Coach Name">
                                    </p>
                                    <p>
                                        <input type="text" name="classdescription" class="form-control input-lg" placeholder="Class description">
                                    </p>
                                    <p>
                                        <input type="text" name="classlength" class="form-control input-lg" placeholder="Class length">
                                    </p>
                                    <p>
                                        <input type="text" name="price" class="form-control input-lg" placeholder="Class price">
                                    </p>
    				            </div>
	    			        </div>
			            <div class="row" id="text">	
				            <div class="ui form">
                                ...
                                <div style='text-align: right'>
                                    <input style="text-align: right"class="btn btn-outline-dark" type="submit" value="Upload" name="upload">	
                                </div>
                            </div>
                        </div>
                    </div>  
            ...
            <?php
                if(isset($_POST['upload'])){
                    ...
                    $class_length = $_POST['classlength'];
                    ...
                    $user = $_SESSION['admindash'];

    			    $insertimage= "INSERT INTO inspired_yoga_classes ( class_name, coach_name, class_description, class_length, price, path, user_id)
	        				    VALUES ('$class_name', '$coach_name', '$class_description', '$class_length', '$class_price', '$filename', '$user')";

                    $result = $conn->query($insertimage);

	    		    if(!$result){
		    		    echo $conn->error;
                    }else{
    				    echo "<p> Class $class_name uploaded. </p>";
	    		    }
		        }
            ?>        
        </div>
