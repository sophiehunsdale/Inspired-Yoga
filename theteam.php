...
<body>
    <div id="container">
        ...
        <div id="text">
            ...
            <h3 id="h3"> Our team </h3>

            <p id="h5">
                At Inspired Yoga, coach requirements include motivation, training, skills, solutions, success and potential!
            </p>
            <p>
                We believe that our team includes professionals who possess the knowledge, skills, and abilities necessary to design safe and effective yoga programs for you. They instruct and assist people in reaching personal health and fitness goals.
            </p>
            <?php
                $read = "SELECT * FROM inspired_yoga_coaches";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $get_coachname = $row['coach_name'];
                    $get_coachemail = $row['coach_email'];
                    $get_coachusername = $row['username'];
                    $get_coachbio = $row['bio'];
                    $get_path = $row['path'];
                                                
                    echo "<p> 
                        <div class='row'>
                            <div class='col-lg-3 col-md-12 col-sm-12' id='imgcol'>
                                <img id='instructor' src='admin/upload/$get_path' />
                            </div>
                            <div class='col-lg-9 col-md-12 col-sm-12' id='textcol'>
                                <h4 id='h3'>$get_coachname</h4>
                                <p> $get_coachbio </p>
                                <p>
                                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='black' width='20px' height='18px'><path d='M0 0h24v24H0V0z' fill='none'/><path d='M3 3h18v2H3V3z'/></svg>
                                </p>
                            </div>
                        </div>
                    </p>";
