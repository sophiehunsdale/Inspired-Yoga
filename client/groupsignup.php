...
<html>
  ...
  <div id="container">
        ...
        <div id="text">
          ...
          <h4 id="h3" class="title">Group Sign Up</h4>
              ...
              <div class='column'>
                <div class='card'>
                          ...
                          if(!isset($_GET['signup'])){
                            ...
                            if(!isset($_SESSION['signed'])){
                                ...
                                echo "<div class='columns'>
                                           <div class='column'>You havent signed up to any groups, <i>yet</i>.</div>
                                      </div>";
                              ...
                              foreach ($_SESSION['signed'] as $result){
                              
                                  $readgroups = "SELECT * FROM inspired_yoga_groups WHERE id='$result';";

                                  $result = $conn->query($readgroups);
                                  ...
                                  echo "<div class='columns is-mobile '>
                                          ...
                                          <div class='column'>
                                            <a href='groupdrop.php?groupid=$group' id='h3'>Drop</a>
                                          </div>     
                              ...
                              if(!isset($_SESSION['signed'])){
                                ...
                                array_push($_SESSION['signed'], $_GET['signup']);
                    ...
                    <footer class='card-footer '>
                          ...
                          <a href='grouphome.php'name='view' class='card-footer-item'style='color:black;'>View My Group</a>
