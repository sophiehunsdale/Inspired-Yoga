            ...
            <nav class="navbar navbar-expand-md navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="collapse_target">
                    ...
                    <a class="nav-link" href="../index.php">home</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="bookings.php">bookings &nbsp;<span class="tag is-black"><?php echo $booked; ?></span></a>                        
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div id="text">
          ...
          <?php
                ...
                while($row=$result->fetch_assoc()){
                    ...
                    $newday=date('d, m, Y', strtotime($theday));
    

                    echo"<div id='text'>
                        <div class='row'>
                             <div class='col-lg-3 col-md-12 col-sm-12' id='imgcol'>
                                <img id='classes' src='$image'>
                            </div>                                    
                            <div class='col-lg-9 col-md-12 col-sm-12' id='textcol'>
                                ...
                                <p>
                                <a href='client/login.php' class='btn btn-outline-dark'>Edit a class</a>
                                </p>
                            </div>
                        </div>
                    </div>
