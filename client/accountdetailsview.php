<?php
    ...
    $readuser = "SELECT * FROM inspired_yoga_users WHERE user_id='$userid';";
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <div id="container">
        ...
        <div id="text">
            <div class='row'>
                <p>
                    <h3 id="h3" class="pad pull-right">Account Details</h3>
                </p>
            </div>
                        ...
                        echo "<p> <div class='card-deck'>
                          <div class='card'>
                                <div class='row'>
                                    <div class='col-sm-3'>
                                        <div style='padding-top:4%; padding-bottom:4%;'>
                                            <img class='card-img-top' style='width:70%;' id='imagecenter' src='../admin/upload/$image' alt='Card image cap'>
                                        </div>
                                    </div>
                                    <div class='col-sm-5'>
                                            ...
                                            <p class='card-text'>
                                                <p> 
                                                    <b>Username:</b> $get_username
                                                </p>
                                                <p> 
                                                    <b>Email:</b> $get_email
                                                </p>
                                                <p>
                                                    <b>Contact Number:</b> $get_contactno 
                                                </p>
                                                <p>
                                                    <b>Address:</b> $get_address_line, $get_city, $get_postcode 
                                                </p>
                                            </p>
                                        </div>
                                    </div>
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='accountdetailsedit.php?edit=$userid' class='btn btn-outline-dark'>Edit</a>
                                    </p>
                                </div>
                            </div>  
                        </div>
