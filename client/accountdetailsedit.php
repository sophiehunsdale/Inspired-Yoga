...
<body>
  <div id="container">
        ...
        <div id="text">
            <div class='row'>
                <p>
                    <h3 id="h3" class="pad pull-right">Edit</h3>
                </p>
            </div>
            <?php
                    $user_id = $_GET['edit'];

                    $readcoach = "SELECT * FROM inspired_yoga_users WHERE user_id='$user_id';";
                    $result = $conn->query($readcoach);
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        $get_password = $row['pass'];
                        $get_user_name = $row['user_name'];
                        $get_email = $row['email'];
                        $get_contactno = $row['contactno'];
                        $get_address_line = $row['address_line'];
                        $get_city = $row['city'];
                        $get_postcode = $row['postcode'];
                        $image = $row['path'];

                        echo "<form method='POST' action='accountdetailsupdate.php'>
                                <input type='hidden' value='$id' name='changeid'>
                                <p> 
                                   Name: 
                                </p>
                                <p>
                                    <input value='$get_user_name' name='changename' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Email: 
                                </p>
                                <p>
                                    <input value='$get_email' name='changemail' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Username: 
                                </p>
                                <p>
                                    <input value='$get_username' name='changeusername' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Password:
                                </p>
                                <p>
                                    <input value='$get_password' type='password' name='changepassword' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Contact Number: 
                                </p>
                                <p>
                                    <input value='$get_contactno' name='changecontactno' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Addresss Line: 
                                </p>
                                <p>
                                    <input value='$get_address_line' name='changeaddressline' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    City: 
                                </p>
                                <p>
                                    <input value='$get_city' name='changecity' class='form-control input-lg'> 
                                </p>
                                <p> 
                                    Postcode: 
                                </p>
                                <p>
                                    <input value='$get_postcode' name='changepostcode' class='form-control input-lg'> 
                                </p>
                                <p> 
    
                                <div style='text-align: right; padding-top:2%;'>
                                    <p> 
                                    <a href='accountdetailsview.php' class='btn btn-outline-dark'>back</a>  <input type='submit' class='btn btn-outline-dark' value='update'> 
                                    </p>
                                </div>
                        </form> ";
