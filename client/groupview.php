...
<body>
    <div id="container">
        ...
        <div id="text">
            ...
            <?php
                $read = "SELECT * FROM `inspired_yoga_groups`";
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <div class='card'>
                            <div class='row'style='padding-left:2%; padding-top:2%;'>
                                <div class='col-sm-5'>
                                        <p id='padding'>
                                            <h4 id='h3'> $groupname</h4>
                                        </p>
                                        </div>
                                        <p class='card-text'>
                                        <p>
                                            <b id='h3'> Description:</b> $groupdescription
                                        </p>
                                        <p>
                                            <b id='h3'> Program: </b> $program
                                        </p>
                                        <p>
                                            <b id='h3'> Exclusive Schedule: </b> $schedule
                                        </p>
                                        <p>
                                            <b id='h3'> Monthly Fee:</b> $$price
                                        </p>
                                </div>
                                <div class='card-footer' style='text-align: right'>
                                    <p>
                                        <a href='groupsignup.php?signup=$id' class='btn btn-outline-dark'>Sign Up</a>
                                    </p>
                                </div>
                                </div>  
                            </div>
