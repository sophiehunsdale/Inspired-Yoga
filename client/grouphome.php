<?php
  ...
  //if(!isset($_SESSION['group'])){
   ...
   // $groupid = $_SESSION['group'];
    //$profile = "SELECT * FROM inspired_yoga_groups WHERE id = '$groupid'";
    ...
    <div id="container">
        ...
        <div id="text">
            ...
            <div class='card-columns' style='padding-top:2%;'>
                            ...
                            <div>
                            <div class="card p-3">
                            <h4 class="card-title" id="h3">Post</h4>
                                <p class="card-text">
                                    <form action='grouphome.php' method='POST' enctype="multipart/form-data">
		                                <div class="ui grid ">
            ...
            <?php
                if(isset($_POST['upload'])){
                    ...
                    $user = $_SESSION['userdash'];
    			          ...
    			          $uploadpost = "INSERT INTO inspired_yoga_group_feed (title, content, publish_date, auth_id)
	        				    VALUES ('$title', '$content', '$publishdate','$user')";

                    $result = $conn->query($uploadpost);

	    		    if(!$result){
		    		    echo $conn->error;
                    }else{
    				    echo "<p> Post: $title uploaded. </p>";
	    		    }
		        }
            ?>
        </div>
