...
<html>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <title>Person Program Subscriptions</title>
  ...
  <div id="container">
        ...
        <div id="text">
          ...
          <h4 id="h3" class="title">Subscriptions</h4>
                ...
                <div class='card'>
                    <div class='card-content'>
                        <div class="columns is-mobile ">
                              <div class='column '>
                                    <h4 id='h3' class="subtitle">Program</h4>
                              </div>
                              <div class='column '>
                                    <h4 id='h3' class="subtitle">Monthly Price</h4>
                              </div>
                              <div class='column '>
                              </div>
                        </div>
                          ...
                          if(!isset($_GET['program'])){
                            ...
                            if(!isset($_SESSION['subscribed'])){
                                ...
                                echo "<div class='columns'>
                                           <div class='column'>You havent subscribed to any personal programs, <i>yet</i>.</div>
                                      </div>";
                              ...
                              foreach ($_SESSION['subscribed'] as $result){
                              
                                  $readprograms = "SELECT * FROM inspired_yoga_training_programs WHERE program_id='$result'";

                                  $result = $conn->query($readprograms);

                                  $row = $result->fetch_assoc();

                                  $name = $row['program_title'];
                                  $pricedata = $row['program_price'];
                                  ...
                                  echo "<div class='columns is-mobile '>
                                          ...
                                          <div class='column'>
                                            <a href='personalprogramunsubscribe.php?programid=$programindex' id='h3'>unsubscribe</a>
                                          </div>     
                              ...
                              if(!isset($_SESSION['subscribed'])){
                                ...
                                $_SESSION['subscribed'] = array();
                                array_push($_SESSION['subscribed'], $_GET['program']);
