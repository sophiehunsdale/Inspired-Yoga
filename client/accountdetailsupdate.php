        ...
        <div id="text">
            <div class="row">
                ...
                <?php 
                    ...
                    $id =  $conn->real_escape_string($_POST['changeid']);
                    $username = $conn->real_escape_string($_POST['changename']);
                    $useremail = $conn->real_escape_string($_POST['changemail']);
                    $userusername = $conn->real_escape_string($_POST['changeusername']);
                    $userpassword = $conn->real_escape_string($_POST['changepassword']);
                    $contactno= $conn->real_escape_string($_POST['changecontactno']);
                    $addressline= $conn->real_escape_string($_POST['changeaddressline']);
                    $city= $conn->real_escape_string($_POST['changecity']);
                    $postcode= $conn->real_escape_string($_POST['changepostcode']);


                    $update = "UPDATE inspired_yoga_users 
                    SET username='$userusername', pass='$user', user_name='$username', 
                        email='$useremail', contactno='$contactno', address_line='$addressline', 
