...
<html>
  ...
  <div id="container">
        ...
        <div id="text">
          ...
          <h4 id="h3" class="title">Bookings</h4>
                ...
                <div class='card'>
                    <div class='card-content'>
                        <div class="columns is-mobile ">
                              <div class='column '>
                                    <h4 id='h3' class="subtitle">Class name</h4>
                              </div>
                              <div class='column '>
                                    <h4 id='h3' class="subtitle">Price</h4>
                              </div>
                              <div class='column '>
                                    <h4 id='h3'  class="subtitle">Edit</h4>
                              </div>
                        </div>
                        <?php
                          ...
                          if(!isset($_GET['class'])){
                            ...
                            if(!isset($_SESSION['classes_booked'])){
                                ...
                                echo "<div class='columns'>
                                           <div class='column'>You havent booked any classes, <i>yet</i>.</div>
                                      </div>";
                               ...
                               foreach ($_SESSION['classes_booked'] as $result){
                              
                                  $readclasses = "SELECT * FROM `inspired_yoga_class_calendar` 
                                  INNER JOIN inspired_yoga_classes 
                                  ON inspired_yoga_class_calendar.class_id = inspired_yoga_classes.class_id WHERE calendar_class_id='$result'";

                                  $result = $conn->query($readclasses);
                                  ...
                                  $newdate=date('l, jS M Y', strtotime($date));
                                  ...
                                  echo "<div class='columns is-mobile '>
                                          ...
                                          <div class='column'>
                                            <a href='bookingsdelete.php?class=$classindex' id='h3'>delete</a>
                                          </div>     
                              ...
                              if(!isset($_SESSION['classes_booked'])){
                                ...
                                $_SESSION['classes_booked'] = array();
                                array_push($_SESSION['classes_booked'], $_GET['class']);
                    ...
                    <footer class='card-footer '>
                          ...
                          <div class='card-footer-item'></div>
                          <a href='#' class='card-footer-item' style='color:black;'>Purchase</a>
                    </footer>
                  </div>
              </div>
        </div>
